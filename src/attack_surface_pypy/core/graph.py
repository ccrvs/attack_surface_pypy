...
class CloudGraph:
    ...
    def traverse_tags_edges(self, ) -> typing.Iterator[typing.Tuple[tag.TagModel, vm.VMModel]]:
        for vm_ in self._vms_nodes:
            for tag_ in vm_.tags:
                yield tag_, vm_

    def traverse_firewall_rules_edges(self, ) -> typing.Iterator[typing.Tuple[tag.TagModel, tag.TagModel]]:
